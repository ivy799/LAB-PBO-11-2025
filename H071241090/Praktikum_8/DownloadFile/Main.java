package Praktikum_8.DownloadFile;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        ScheduledExecutorService uiExecutor = Executors.newSingleThreadScheduledExecutor();
        ...
        for (int i = 1; i <= totalFiles; i++) {
            ...
            downloadExecutor.execute(() -> {
                try {
                    ...
                    int duration = 1 + random.nextInt(3); // 1–3 detik
