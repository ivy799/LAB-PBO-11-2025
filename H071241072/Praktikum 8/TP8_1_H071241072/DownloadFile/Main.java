    ...
    public static void main(String[] args) {
        ...
        for (int i = 1; i <= totalFiles; i++) {
            ...
            downloadExecutor.submit(() -> {
                int duration = new Random().nextInt(3) + 1; // random antara 1-3 detik
                try {
        ...
        try {
            ...
            System.out.println("Download executor interrupted.");
        }
        // TODO (8)
        ...
        uiExecutor.shutdown();
        try {
            uiExecutor.awaitTermination(3, TimeUnit.SECONDS);
        } catch (InterruptedException e) {
            System.out.println("UI executor interrupted.");
        }
